...
MealCube Tracker is a local-first iOS 17 SwiftUI app for planning LDL-friendly, high-protein freezer meals in Souper Cubes-style portions.
...
Open `MealCubeTracker.xcodeproj` in Xcode and run the `MealCubeTracker` scheme.
